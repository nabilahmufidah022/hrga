...
use Ppl\Hrga\Controllers\CtrlBasePersonal;
use Ppl\Hrga\Models\Reportpersonal as LaporanPersonal;
...
/**
 * Reportpersonals Backend Controller
 */
class Reportpersonals extends CtrlBasePersonal
{
    /**
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Ppl.Hrga', 'homes', 'reportpersonals');
    }
    public function exportXls() {
        date_default_timezone_set('Asia/Jakarta');
        $qMdl = new LaporanPersonal;
        $q = $qMdl->orderBy('created_at','desc');
