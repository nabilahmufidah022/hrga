...
use Ppl\Hrga\Controllers\CtrlBaseDeviceOrder;
use Ppl\Hrga\Models\Reportdeviceorder as LaporanDeviceOrder;
...
/**
 * Reportdeviceorders Backend Controller
 */
class Reportdeviceorders extends CtrlBaseDeviceOrder
{
    /**
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Ppl.Hrga', 'homes', 'reportdeviceorders');
    }
    ...
    public function exportXls() {
        ...
        $qMdl = new LaporanDeviceOrder;
        $q = $qMdl->orderBy('created_at','desc')->where('flag_status', '!=', 4 );
        
        $colNames = [
            'Nama Peminjam Perangkat',
            'Unit Kerja',
            'No WA',
            'Tanggal Awal Peminjam Perangkat',
            'Tanggal Terakhir Peminjam Perangkat',
            'Perangkat',
            'Jumlah Peminjaman Perangkat',
            'Keterangan Peminjam Perangkat'
        ];
        $fields = [
            'nama',
            'divisi_id',
