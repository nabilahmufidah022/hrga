...
use Ppl\Hrga\Controllers\CtrlBaseAbsence;
use Ppl\Hrga\Models\Reportabsence as LaporanAbsensi;
...
/**
 * Reportabsences Backend Controller
 */
class Reportabsences extends CtrlBaseAbsence
{
    /**
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Ppl.Hrga', 'homes', 'reportabsences');
    }

    public function exportXls() {
        date_default_timezone_set('Asia/Jakarta');
        $qMdl = new LaporanAbsensi;
