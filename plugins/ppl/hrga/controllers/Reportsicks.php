...
use Ppl\Hrga\Controllers\CtrlBaseSick;
use Ppl\Hrga\Models\Reportsick as LaporanSick;
...
/**
 * Reportsicks Backend Controller
 */
class Reportsicks extends CtrlBaseSick
{
    /**
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Ppl.Hrga', 'homes', 'reportsicks');
    }
    ...
    public function exportXls() {
        ...
        $colNames = [
            ...
            'No WA',
            'Tanggal Awal Sakit',
            'Tanggal Terakhir Sakit',
            'Jumlah Rencana Sakit',
            'Jenis Sakit',
            'Keterangan Sakit'
        ];
        $fields = [
